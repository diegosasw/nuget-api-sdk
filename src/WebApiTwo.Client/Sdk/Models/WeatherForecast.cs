...
using System.Linq;
using System;
namespace WebApiTwo.Client.Sdk.Models
{
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="WebApiTwo.Client.Sdk.Models.WeatherForecast"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static WebApiTwo.Client.Sdk.Models.WeatherForecast CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new WebApiTwo.Client.Sdk.Models.WeatherForecast();
        }
        /// <summary>
